...
<body class="d-flex flex-column min-vh-100">
    ...
    <div class="conteiner">
        <div class="form-group">
            <h3 style="text-align: center;">EXCLUIR USUÁRIO</h3>
        </div>
        ...
        <form id="formExcluir" name="formAlterar" method="post" action="deletaUser.php">
            ...
            <div class="form-group">
                <div class="col-md-6 offset-md-3">
                    <label>USUÁRIO: </label>
                    <input type="text" name="apelido" id="apelido" size="35" value="<?php print $apelido; ?>" readonly>
                </div>
            </div>

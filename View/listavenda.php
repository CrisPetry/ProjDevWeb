...
<body class="d-flex flex-column min-vh-100">
        ...
        <div class="jumbotron">
            <div class="card">
                ...
                <div class="content">
                    ...
                    <a href="deletavenda.php" class="text-decoration-none">
                        <button type="button" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                    </a>

                    <a href="editavenda.php" class="text-decoration-none">
                        <button type="button" class="btn btn-primary"><i class="fa fa-edit"></i></button>
                    </a>

                    <a href="inserevenda.php" class="text-decoration-none">
    ...
    <script>
        $('.add').click(function() {
            window.location.href = 'inserevenda.php';
        })
    </script>

    <script>
        $('.delete').click(function() {
            window.location.href = 'deletavenda.php';
        })
    </script>
</body>
